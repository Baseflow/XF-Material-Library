...
namespace XF.Material.Maui.UI.Dialogs.Configurations
{
    ...
    public class MaterialSnackbarConfiguration : BaseMaterialDialogConfiguration
    {
        ...
        /// </summary>
        public override Color BackgroundColor { get; set; } = Color.FromArgb("#343434");
        ...
        /// </summary>
        public override Color MessageTextColor { get; set; } = Color.FromArgb("#DEFFFFFF");

        /// <summary>
        /// Gets or sets the tint color to be used for the snackbar's button.
        /// </summary>
        public override Color TintColor { get; set; } = Colors.Yellow;

        /// <summary>
        /// Gets the scrim color of the snackbar.
        /// </summary>
        public override Color ScrimColor => Colors.Transparent;
